...
def cross_validation_reg_logistic_regression(y, x, lambdas, initial_w, max_its, gammas, fold_nums, verbose=False):
    ...
    # Keep track of losses for each value of each hyper parameter
    losses_per_hp = dict(
    ...
    for lambda_, max_it, gamma in product(lambdas, max_its, gammas):
        if verbose:
    ...
    return best_loss, best_hps, losses_per_hp